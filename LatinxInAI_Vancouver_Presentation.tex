...
\veryHuge \color{NavyBlue} \textbf{An algorithm to recommend activities in scientific workflows:} \color{Black}\\ % Title
\Huge\textit{An ontology, artificial inteligence and frequency-based approach}\\[2cm] % Subtitle
\huge \textbf{PhD Candidate Adilson Lopes Khouri \& \\  PhD Luciano Antonio Digiampietri}\\[0.5cm] % Author(s)
...
\begin{center}
\captionof{figure}{Techniques of related literature grouped}
\includegraphics[height=14cm, width=28cm]{GraficoQuantidadeTecnica.png}
\end{center}
...
\begin{center}
\captionof{figure}{Proposed recommendation engine}
...
%\captionof{figure}{Comparison between proposed algorithm and the literature techniques}
%\end{center}
\vspace{1cm}
\centering
