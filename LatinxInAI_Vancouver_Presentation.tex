...
\begin{center}
\captionof{figure}{Recommendation engine}
\includegraphics[height=16cm, width=28cm]{draw2.png}
\end{center}
...
%\begin{center}
%\captionof{figure}{Matrix of scientific workflows}
...
\captionof{figure}{Adapted matrix of scientific workflows used in classification and regression problems }
