...
\huge \color{NavyBlue} \textbf{An algorithm to recommend activities in scientific workflows:} \color{Black}\\ % Title
\LARGE\textit{An ontology, artificial inteligence and frequency-based approach}\\[2cm] % Subtitle
